#' Write out solar radiation SWAT 2012 meteorology input file
#'
...
#' @param time_name character, optional: name of the time stamp column, default = 'time_posix'
#'
#' @export
#'
#' @examples
...
#' 
write_input_swat2012_slr <- function(file, data, station_names, col_time_name = 'time_posix') {
  write_input_swat2012_other(file, data, station_names, 'slr', col_time_name)
}