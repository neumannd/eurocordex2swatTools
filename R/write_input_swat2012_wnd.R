#' Write out wind speed SWAT 2012 meteorology input file
#'
...
#' 
write_input_swat2012_wnd <- function(file, data, station_names, col_time_name = 'time_posix') {
  write_input_swat2012_other(file, data, station_names, 'wnd', col_time_name)
}